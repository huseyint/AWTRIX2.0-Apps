...
Sub App_startDownload(jobNr As Int)
	Select jobNr
		Case 1
			App.DownloadURL= "https://free.currencyconverterapi.com/api/v6/convert?q=USD_TRY&compact=ultra&apiKey=368ebc0b167197fbad19"
	End Select
End Sub
		...
		If Resp.success Then
			Select Resp.jobNr
				Case 1
					...
					Dim pric As Double  = root.Get("USD_TRY")
...
Sub App_genFrame
	...
	App.drawBMP(0,0,App.getIcon(520),8,8)
End Sub